...
public class JsonApiActivity extends AppCompatActivity {
    ...
    private ListView lv;
    // URL to get contacts JSON (updated to a working endpoint)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acara38_json_api);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    // Parse as JSONArray directly (no outer object with "contacts")
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        // Phone is a direct string field
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    R.layout.acara38_list_item, new String[]{"name", "email", "mobile"},
